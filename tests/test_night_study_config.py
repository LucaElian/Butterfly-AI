...
def test_night_curriculum_excludes_deterministic_capabilities():
...
def test_night_recipes_exist_and_have_no_binding_training_skill():
    for name in ("night_epistemic", "night_instruction"):
