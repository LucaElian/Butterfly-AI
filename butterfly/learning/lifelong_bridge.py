...
def enrich_legacy_lesson(lesson: dict[str, Any]) -> dict[str, Any]:
    ...
    result.update({
        ...
        "checkpoint_selection_min_delta": float(cfg.get("checkpoint_selection_min_delta", 0.0)),
        "checkpoint_protected_slack": float(cfg.get("checkpoint_protected_slack", 0.0)),
        "learning_packet_cases": int(cfg.get("learning_packet_cases", 0)),
...
def curriculum_lessons(
    ...
    for node_id, binding in bindings.items():
        ...
        rows.append({
            ...
            "checkpoint_selection_min_delta": float(dyn_cfg.get("checkpoint_selection_min_delta", 0.0)),
            "checkpoint_protected_slack": float(dyn_cfg.get("checkpoint_protected_slack", 0.0)),
            "learning_packet_cases": int(dyn_cfg.get("learning_packet_cases", 0)),
...
def focus_target_for_lesson(lesson: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "checkpoint_selection_min_delta": float(lesson.get("checkpoint_selection_min_delta", 0.0)),
        "checkpoint_protected_slack": float(lesson.get("checkpoint_protected_slack", 0.0)),
        "learning_packet_cases": int(lesson.get("learning_packet_cases", 0)),
